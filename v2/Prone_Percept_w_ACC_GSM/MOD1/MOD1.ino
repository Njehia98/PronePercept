...
void loop() // run over and over again
{
  ...
  if (millis() - timer > 2000) {
    ...
    UpdateSerial.print(hr); UpdateSerial.print("|"); UpdateSerial.print(mn); UpdateSerial.print("|"); UpdateSerial.print(sc); UpdateSerial.print("|"); 
    UpdateSerial.print(dy); UpdateSerial.print("|"); UpdateSerial.print(mo); UpdateSerial.print("|"); UpdateSerial.print(yr); UpdateSerial.print("|");
    UpdateSerial.print(rev_latitude); UpdateSerial.print("|"); UpdateSerial.print(rev_longitude); UpdateSerial.print("|"); UpdateSerial.print(spd); UpdateSerial.print("|");
