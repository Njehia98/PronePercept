...
<div style="padding-top:30px;padding-left:15px;">
	<label class="dropdown">
		<select onChange="getvinno(this.value);">
...
<div style="padding-top:10px;padding-left:15px;">
	<label class="dropdown">
		<select id = 'vinno' onChange="getcarinfo(this.value);">
			<option selected = 'true' disabled='disabled'>Choose a region before V.I.N.:</option>
			<option disabled='disabled'>----</option>
		</select>
	</label>
</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						<h4 class="title" style="font-weight:100;"><span style="font-weight:bold;">No</span> Car Distinction</h4>
						<p class="category">Please select the V.I.N. to view car data</p>
					</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						<h4 class="title" style="font-weight:100;"><span style="font-weight:bold;">No</span> Car Specs</h4>
						<p class="category">Please select the V.I.N. to view car data</p>
					</div>
					<div class="content table-responsive table-full-width">
						<table class="table table-hover">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						<h4 class="title" style="font-weight:100;"><span style="font-weight:bold;">No</span> Insurance Details</h4>
						<p class="category">Please select the V.I.N. to view car data</p>
					</div>
					<div class="content table-responsive table-full-width">
						<table class="table table-hover">
