...
int pezPinone = 1;
int pezPinzero = 0;
String vinno = "YYYYYYYYYYYYYYYYY";
...
if (valfive == 0) {
  ...
  String datafive = ""+vinno+"|"+latitude+","+longitude+"|Right|";
...
if (valfour == 0) {
  ...
  String datafour = ""+vinno+"|"+latitude+","+longitude+"|Left|";
...
if (valthree == 0) {
  ...
  String datathree = ""+vinno+"|"+latitude+","+longitude+"|Rear|";
...
if (valtwo == 0) {
  ...
  String datatwo = ""+vinno+"|"+latitude+","+longitude+"|Front|";
...
if (valone == 0) {
  ...
  String dataone = ""+vinno+"|"+latitude+","+longitude+"|Top|";
